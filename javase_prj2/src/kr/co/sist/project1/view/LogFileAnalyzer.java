...
public class LogFileAnalyzer extends JFrame {
	...
	// 라벨 : 화면출력용 //
	private JLabel labelLinecnt, label1Key, label2Browser, label3Access, label4AskTime, label5Fail403, label6RangeKey;
	...
	public LogFileAnalyzer() {
		...
		// 라벨 //
		labelLinecnt = new JLabel("");
		label1Key = new JLabel("");
		label2Browser = new JLabel("");
		label3Access = new JLabel("");
		label4AskTime = new JLabel("");
		label5Fail403 = new JLabel("");
		label6RangeKey = new JLabel("");

		/* 보더설정 */
		labelLinecnt.setBorder(new TitledBorder("라인 갯수"));
