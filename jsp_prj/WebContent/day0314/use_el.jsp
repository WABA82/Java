<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false" info="EL연습"%>
...
<body>
	<div id="wrap">
		...
		<div id="container">
			...
			<div>
				<strong>EL을 사용하여 파라미터 처리</strong>
				<ul>
					<li>이름 : <strong><c:out value="${empty param.name ? '아래 링크를 클릭하거나 폼에 입력해 주세요' : param.name}" /></strong></li>

					<li>나이 : <strong>${empty param.age ? '아래 링크를 클릭하거나 폼에 입력해 주세요' : param.age}</strong></li>
					<!-- 
						EL을 사용하여 출력하면 XSS 취약점을 가지게 된다.
						XSS(Cross Site Script) : 악의적인 목정의 사용자가 HTML Form Control이나 
						QuertString에 JavaScript Code를 작성하여 서버에서 실행 시키기 위한 취약점.
			...
			<a href="use_el.jsp?name=jungyun&age=30">파라미터 연습</a>
