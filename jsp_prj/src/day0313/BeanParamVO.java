...
/**
 * HTML Form Control의 이름과 VO의 instance 변수명이 반드시 같아야 합니다.
 * 
 * @author owner
 */
public class BeanParamVO {
	private String id, pass1, name, ssn1, ssn2, gender, marrigeFlag, m_year, m_month, m_day, zipcode, addr1, addr2,
			greetings;
