...
public class DiaryVO {
	...
	public DiaryVO(String writer, String subject, String contents, String e_year, String e_month, String e_day, String pass, String ip) {
		this.writer = writer;
	...
	public String toString() {
		return "DiaryVO [writer=" + writer + ", subject=" + subject + ", contents=" + contents + ", e_year=" + e_year + ", e_month=" + e_month + ", e_day=" + e_day + ", pass=" + pass + ", ip=" + ip + "]";
	}// toString
