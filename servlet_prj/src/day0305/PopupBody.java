		...
		if (cookies != null) { // 쿠키가 존재 한다면
			...
			for (int i = 0; i < cookies.length; i++) {
				...
				if("popup_date".equals(readCookie.getName())) {
					...
					String value = readCookie.getValue(); // 쿠키가 심어진 날짜
					String nowDate = new SimpleDateFormat("yyyyMMdd").format(new Date()); // 오늘 날짜.
	      ...
	      /////////////////////////////////////////////////////////////////////////////
	      out.println("<h2>정윤이의 철권세상에 잘오셨습니다.</h2>");
	      out.println("<img src='common/images/img.png' title='게임은 수업시간에 해야 제맛!'>");
	      out.println("<h3>이번 주 정모는 강남역 지하 게임 센터에서 화요일 19:00시 부터 진행 됩니다.</h3>");
