...
//		}
		...
		if (list == null) { // DB에서 문제가 발생한 경우.
			out.println("<tr><td colspan='7'>죄송합니다. 문제가 발생하였습니다.</td></tr>");
		} else {
			EmpVO ev = null;
			...
			if(list.isEmpty()) {
				out.println("<tr><td colspan='7'>사원정보가 존재하지 않습니다.<br/>");
				out.println("<img src='common/images/img2.jpg' title='#일안하냐?#사원관리'>");
				out.println("</td></tr>");
			}// end if
