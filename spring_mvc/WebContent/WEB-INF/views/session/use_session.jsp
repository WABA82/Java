<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" info="세션 값을 사용하는 페이지 입니다."%>
	...
	<div id="wrap">
		...
		<div id="container">
			<div>
				<strong>세션 사용</strong>
				<br>
				<strong>${ sessionScope.flag }</strong>
				<br>
				<strong>이름 : </strong>${ sessionScope.ses_name }
				<br>
				<strong>주소 : </strong>${ sessionScope.ses_addr }
			</div>
		</div>
