		...
		<div id="container">
			<div>
				<form action="an_session_param.do" method="post">
					<label>이름 : </label> <input type="text" name="name" class="inputBox" value="${ an_name }">
					<br>
					<label>주소 : </label> <input type="text" name="addr" class="inputBox" value="${ an_addr }">
					<br>
					<input type="submit" value="전송" class="btn"><a href="an_remove_session.do">세션삭제</a>
				</form>
			</div>
		</div>
