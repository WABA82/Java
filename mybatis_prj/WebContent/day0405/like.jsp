...
<input type="submit" value="동 조회" class="btn"/><br/>
예) 상도동, 역삼동
</form>
<div>
<c:if test="${not empty param.dong}">
	<div>
	<strong>${param.dong}</strong>의 조회
	</div>
	<table border="1">
		<tr>
			<th width="80">우편번호</th>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=02ab7b2d01ea269b1e16110c27aa30b0&libraries=services"></script>
	...
	// 주소-좌표 변환 객체를 생성합니다
	var geocoder = new daum.maps.services.Geocoder(addr);
		// 주소로 좌표를 검색합니다
