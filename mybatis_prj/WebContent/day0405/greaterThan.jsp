...
<form name="frm" action="main.jsp">
	<input type="hidden" name="page" value="day0405/greaterThan" /> <label>연봉</label> <input type="text" name="sal" class="inputBox" /> <input type="submit" value="연봉 조회" class="btn" />
</form>
<div>
	<c:if test="${not empty param.sal}">
		<div>
			<strong>${param.sal }</strong>보다 연봉을 많이 받는 사원 정보
		</div>
		<table border="1">
			<tr>
				<th width="40">번호</th>
