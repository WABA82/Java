...
<%
	...
	if (deptno != null && !"".equals(deptno)) {
		...
		c_vo.setDeptno(Integer.parseInt(deptno));
		mb_dao.selectProc(c_vo);
		pageContext.setAttribute("empList", c_vo.getEmpList());
	} //end if
%>

<form name="frm" action="main.jsp">
	<input type="hidden" name="page" value="day0411/select_procedure" /> <label>부서번호</label>
