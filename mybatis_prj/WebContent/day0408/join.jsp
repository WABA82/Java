...
%>
<div>
	<c:set var="mgr" value="7566.7698.7788.7839.7782.7902.7782"/>
	<c:forTokens items="${ mgr }" delims="." var="mgr">
...
<div>
	<table border="1">
		...
		<c:if test="${ empty empList }">
			<tr>
				<td colspan="7" align="center">${ param.mgr }매니저가관리하는 사원은 존재하지 않습니다.</td>
			</tr>
		</c:if>
